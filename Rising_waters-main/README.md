...
erDiagram
  ...
  MODEL ||--o{ PREDICTION_RESULT : uses
  PREDICTION_REQUEST ||--o{ PREDICTION_RESULT : produces
```
...
1. Run the Flask backend first.
2. Run the Streamlit frontend.
3. Open the Streamlit URL in a browser.
4. Use the Prediction page to enter feature values.
